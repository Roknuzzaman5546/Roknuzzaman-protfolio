        ...
        <div
            ...
            <div className=" grid md:grid-cols-10 mt-5 text-white gap-2">
                <div className=" md:col-span-6 w-full">
                    {/* Experience */}
                    <h2 className="border-b-[4px] border-[#ff714a] text-2xl font-bold pb-1 inline-block mb-2 mt-5">Experience</h2>
                    <div className=" flex">
                    ...
                    {/* certificate now comment when need then it uncomment */}
                    <div className=" mt-3">
                        {/* PH certificate */}
                        {/* <div className=" flex">
                            <div className="md:w-[30%] w-[40%] text-right border-r border-gray-300 pr-2">
                    ...
                    {/* Download cv */}
                    <a target="blank" href="https://drive.google.com/file/d/17ezT-XH6xKGCCYlfF-q5wh7LbukOq8Kz/view?usp=sharing">
